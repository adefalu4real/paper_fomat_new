...
import {
  simulateFormatPreviewApi,
  simulateGeneratePdfApi,
...
const App: React.FC = () => {
  ...
  const handleFileChange = async (
    ...
    if (file) {
      try {
        ...
        // FIX: The unused '(err: unknown)' parameter has been removed.
  ...
  const showKeywordsInput =
    selectedFormat === FormatType.IEEE ||
    selectedPaperType === PaperType.JournalArticle;
        ...
        <MainContainer>
          <ControlsWrapper>
            ...
            <StyledInput
              ...
              placeholder="e.g @The role of computer in human life "
            />
            ...
            <StyledSelect
              ...
              onChange={(e) =>
                setSelectedPaperType(e.target.value as PaperType)
              }
            >
            ...
            <DownloadButton
              ...
              disabled={showLoading || !isDownloadEnabled}
            >
